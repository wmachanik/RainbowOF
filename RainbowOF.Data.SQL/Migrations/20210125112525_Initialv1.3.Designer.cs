...
namespace RainbowOF.Data.SQL.Migrations
{
    ...
    [Migration("20210125112525_Initialv1.3")]
            ...
            modelBuilder.Entity("RainbowOF.Models.Items.ItemAttributeVariety", b =>
                {
                    ...
                    b.HasIndex("ItemId", "ItemAttributeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("RainbowOF.Models.Items.ItemCategory", b =>
                {
                    ...
                    b.Property<Guid>("ItemCategoryLookup")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RainbowOF.Models.Items.ItemAttributeVariety", b =>
                {
                    ...
                    b.HasOne("RainbowOF.Models.Items.ItemUoMLookup", "ItemUoMLookup")
                        .WithMany()
                        .HasForeignKey("ItemUoMId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("ItemUoMLookup");
                });
